...
public class DepartamentoController {
	...
	// MÉTODOS PROPIOS
	/*
	 * CREAR Los datos devueltos de la petición son devueltos como objects y hay que
	 * castearlos.
	 */
	@PostMapping()
	...
	public ResponseEntity<Void> borrarDepartamento(@PathVariable ("id") Long id) {
		departamentoServices.deleteDepartamentoId(id);
